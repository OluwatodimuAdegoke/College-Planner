    ...
    <SafeAreaView className="flex-1 justify-center bg-white p-5">
        ...
        >
            <View className="justify-center align-middle flex-1">
                ...
                <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} className="self-end px-2"><Text>Close</Text></TouchableOpacity>
                <Text className="text-center font-bold text-xl">Email Address</Text>
                <View className="h-12 m-2">
                    <TextInput className="bg-gray-100 flex-1 rounded-lg px-2 pr-2" maxLength={30} placeholder='Email Address' value={fEmail} onChangeText={value => setFEmail(value)}/>
                </View>
                <TouchableOpacity onPress={ async () =>{ 
                    ...
                    <Text className="self-center font-semibold text-xl">Reset Password</Text>
                </TouchableOpacity>
                </View>
            </View>
        ...
        <View className="flex-row justify-between">
            <TouchableOpacity onPress={() => setModalVisible(true)}><Text className="underline  mt-2">Forgot Password?</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => {navigation.navigate("Register")}}><Text className="underline mt-2">Register?</Text></TouchableOpacity>
        </View>

        <View>
            <TouchableOpacity onPress={() => loginUser({email: email, password: password, navigator: navigation})} className="bg-gray-200 rounded-lg h-11 w-24 justify-center self-center mt-2">
